...
#./output/ricoTest/LayoutGAN++/20230221184830307270/model_best.pth.tar --const_type relation --out_path output/relation/generated_ricoTest_relation7270.pkl --num_save 50
